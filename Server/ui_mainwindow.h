...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        activeUser->setGeometry(QRect(100, 275, 750, 150));
        userAv = new QLabel(centralWidget);
        userAv->setObjectName(QStringLiteral("userAv"));
        userAv->setGeometry(QRect(980, 275, 150, 150));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        logoLabel->setText(QApplication::translate("MainWindow", "RAT - Server", Q_NULLPTR));
        ...
        activeUser->setText(QApplication::translate("MainWindow", " is using this PC", Q_NULLPTR));
        userAv->setText(QApplication::translate("MainWindow", "AVATAR", Q_NULLPTR));
